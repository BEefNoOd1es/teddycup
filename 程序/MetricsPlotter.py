...
DEFAULT_PLOT_PATH = Path("result/净值走势对比图.png")
...
def load_benchmark(benchmark_path: Path, strategy_df: pd.DataFrame) -> pd.DataFrame:
    ...
    if benchmark_path and benchmark_path.exists():
        ...
        rename_map = {"trade_date": "date", "日期": "date", "收盘": "close", "Close": "close"}
        ...
        aligned["net_value"] = aligned["net_value"].fillna(method="ffill")
        aligned["net_value"] = aligned["net_value"].fillna(method="bfill")
